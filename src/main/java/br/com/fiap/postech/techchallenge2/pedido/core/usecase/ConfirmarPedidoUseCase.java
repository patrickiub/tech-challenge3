...
import br.com.fiap.postech.techchallenge2.pedido.core.exception.PedidoNaoPertenceClienteException;
...
public class ConfirmarPedidoUseCase {
    ...
    public Pedido executar(Long pedidoId, Long clienteId) {
        ...
        pedido.confirmar(); // regra de negócio encapsulada no domínio
        return pedidoGateway.atualizarStatus(pedido); // gateway recebe objeto de domínio
    }
